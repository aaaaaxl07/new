...
\x1b[1;92m         Ezekiel Clervo Recode~
\x1b[1;91m-----------------------------------------------
\x1b[1;97m> Author : Ezekiel CLervo
\x1b[1;97m> Github : Not Found
\x1b[1;97m> Facebok: Ezekiel Clervo
\x1b[1;97m> Version: BOBO SI ISAAC MAG-UPDATE KAYA SI ALEX NA BAHALA
\x1b[0;97m-----------------------------------------------"""
boy = ['Yuji Montefalco', 'Alex Gray', 'Aifel Velasquez', 'Ken oxford', 'Neo Oxford', 'Reign Smith', 'Jun Neil', 'Kaizen Ramirez', 'Kai Kai', 'Aireen Montefalco', 'Jenny Ramirez', 'Khairo Khan', 'Jim mmy', 'Thairo Krito', 'Kaiz Zer', 'Yim Neil', 'Jerry Montefalco', 'Jim Jvska', 'Yuno Montefalco', 'Kenjie Montefalco', 'Yuro Oxford']
...
class create:
    ...
    def start(self):
        os.system('clear')
        print (logo4)
        print ('[1] BRP NAME IDS')
        print ('[2] GRP NAME IDS')
        print (47*'-')
        gen = input('select: ')
        print (47*'-')
        if gen in ['1', '01']:
    ...
    # 'cookie': 'datr=PL1DZTST7YJhpMhroiyoKrYa; sb=PL1DZaviMcRjZJDB7BhyqUH7; wd=424x804; fr=0ll6MkAyNPrXAGtRy..BlQ708.i4.AAA.0.0.BlQ71Y.AWWo74mHSKY',
    ...
    'viewport-width': '980',}
        ...
        for x in range(lim):
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[1;33m[DEAD] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
        ...
        print (47*'-')
        print ('\033[1;32mTotal ids > ALIVE/' +str(len(ok)) + ' DEAD/' + str(len(cp)))
        print (47*'-')
        input('back')
        menu()
menu()